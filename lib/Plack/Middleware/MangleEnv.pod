...
This sub applies the procedure exposed in the L</DESCRIPTION> and it
...
non-reference scalars: L</generate_value_manglers>
...
=head2 B<< generate_value_manglers >>
